...
export default function InternalGetCIDPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/api/getcid/internal', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ installationId: cleanIid }),
            });
                        ...
                        <div className="p-4">
                            <ol className="space-y-2 text-sm text-[#0F1111]">
                                ...
                                <li className="flex gap-2">
                                    ...
                                    <span>Enter your Installation ID below</span>
                                </li>
                                <li className="flex gap-2">
                    ...
                    <div className="bg-white rounded-lg shadow-lg border border-[#DDD] overflow-hidden">
                        ...
                        <div className="bg-gradient-to-b from-[#F7F8FA] to-[#E7E9EC] px-6 py-4 border-b border-[#DDD]">
                            ...
                            <p className="text-sm text-[#565959] mt-1">
                                Enter your Installation ID below to get your Confirmation ID
                            </p>
                        </div>
                        ...
                        <div className="p-6">
                            {confirmationId ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading || digitCount !== 63}
