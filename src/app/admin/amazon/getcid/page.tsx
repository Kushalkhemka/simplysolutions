                        ...
                        <div className={`p-4 rounded-lg ${result.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
                            {result.success ? (
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-green-600 mb-1">Confirmation ID:</p>
                                        <div className="flex items-center gap-2">
                                            <code className="text-sm font-mono bg-white px-2 py-1 rounded break-all">
                                                {result.confirmationId}
                                            </code>
                                            <button onClick={() => copyToClipboard(result.confirmationId)} className="text-green-700 hover:bg-green-100 p-1 rounded">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {result.canRetry && (
                                        <p className="text-xs text-red-600">You can retry this request.</p>
                                    )}
                                </div>
                            )}
                        </div>
