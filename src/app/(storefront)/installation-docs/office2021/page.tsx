...
export const metadata = {
    title: 'Microsoft Office 2021 Installation Guide | SimplySolutions',
    description: 'Complete step-by-step guide to install and activate Microsoft Office Professional Plus 2021 on Windows',
};

export default function Office2021GuidePage() {
    return (
                ...
                <div className="mb-10">
                    ...
                    <div className="text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold mb-3 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                            MS OFFICE 2021 PROFESSIONAL PLUS
                        </h1>
