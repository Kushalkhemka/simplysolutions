...
export const metadata = {
    title: 'Windows 10/11 Pro Installation Guide | SimplySolutions',
    description: 'Complete step-by-step guide to install and activate Windows 10/11 Professional',
};

export default function Win1011ProPage() {
    return (
            ...
            <div className="container max-w-5xl py-10 px-4 mx-auto">
                ...
                <div className="mb-10">
                    ...
                    <div className="text-center">
                        <div className="inline-block px-4 py-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-medium rounded-full mb-4">
                            Complete Guide
                        </div>
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Follow these instructions to install and activate Windows 10/11 Professional.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-8 mb-12">
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold">Enter Product Key During Installation</h3>
                                <p className="text-muted-foreground">You may be prompted to enter the product key during installation</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">If Windows 11 is already installed: Start → Settings → System → Activation → Update product key → Change product key → Click Change</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">Enter the product key to activate Windows 11 Professional</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-8 mb-12">
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold">Activate After Installation</h3>
                                <p className="text-muted-foreground">If Windows 10 is already installed: Start → Settings → Update & Security → Activation → Change product key</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold">Enter Product Key</h3>
                                <p className="text-muted-foreground">Enter the product key to activate Windows 10 Professional</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 border-2 border-green-300 dark:border-green-700 rounded-2xl p-6 shadow-lg mb-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-green-700 dark:text-green-300">Your Windows Professional is now activated!</p>
                        </div>
                    </div>
                </div>

                {/* Important Note for Home to Pro */}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-card border rounded-2xl p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div className="relative rounded-xl overflow-hidden border shadow-lg">
                                    <Image
                                        src="https://api.simplysolutions.co.in/storage/v1/object/public/product-assets/installation-guide-images/3-1170x603.jpg"
                                        alt="Installation ID"
                                        width={350}
                                        height={200}
                                        className="w-full h-auto"
                                ...
                                <div className="relative rounded-xl overflow-hidden border shadow-lg">
                                    <Image
                                        src="https://api.simplysolutions.co.in/storage/v1/object/public/product-assets/installation-guide-images/Screenshot-2024-12-03-171018.png"
                ...
                <div className="mt-8 text-center bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-2xl p-8 border">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://wa.me/919711397918" target="_blank" rel="noopener noreferrer">
