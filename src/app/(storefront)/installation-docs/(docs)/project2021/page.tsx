...
import { ArrowLeft, CheckCircle, Key, Info, ExternalLink, Download, Settings } from 'lucide-react';
import { Button } from '@/components/ui/button';

export const metadata = {
    title: 'Project 2021 Professional Installation Guide | SimplySolutions',
    description: 'Complete step-by-step guide to install and activate Microsoft Project 2021 Professional',
};

export default function Project2021Page() {
    return (
            ...
            <div className="container max-w-5xl py-10 px-4 mx-auto">
                ...
                <div className="mb-10">
                    ...
                    <div className="text-center">
                        <div className="inline-block px-4 py-1.5 bg-gradient-to-r from-teal-500 to-cyan-500 text-white text-sm font-medium rounded-full mb-4">
                            Complete Guide
                        </div>
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Follow these instructions to install and activate Microsoft Project Professional 2021.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-2xl p-6 mb-8">
                    <div className="flex gap-4">
                        ...
                        <div>
                            <p className="font-bold text-amber-800 dark:text-amber-200 mb-2">Important Before Installation</p>
                            <ul className="list-disc list-inside space-y-1 text-amber-700 dark:text-amber-300">
                                <li>If any old Microsoft Project version is installed, <strong>uninstall it first</strong></li>
                                <li>Restart your PC after uninstalling</li>
                                <li>If uninstall is stuck, use: <a href="https://tinyurl.com/uninstallofficesuite" target="_blank" rel="noopener noreferrer" className="underline hover:text-amber-900">tinyurl.com/uninstallofficesuite</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-8 mb-12">
                    <div className="bg-card border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4 mb-5">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">1</div>
                            <div>
                                <h3 className="text-2xl font-bold">Download Project Professional 2021</h3>
                                <p className="text-muted-foreground">Download the official Retail image file (~4.7 GB)</p>
                            </div>
                        </div>
                        <div className="ml-14">
                            <a href="https://bit.ly/project-pro-2021" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" className="gap-2 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white shadow-lg">
                                    <Download className="h-5 w-5" />
                                    Download Project 2021 Professional
                                </Button>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">2</div>
                            <div>
                                <h3 className="text-2xl font-bold mb-3">Install Project 2021</h3>
                                <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                                    <li>Run the downloaded setup file</li>
                                    <li>Complete the installation process</li>
                                    <li>Restart your PC once after installation</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold mb-3">Activate Project 2021</h3>
                                <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                                    <li>Open Microsoft Project 2021</li>
                                    <li>When prompted, enter your Project 2021 license key</li>
                                    <li>On Activation Wizard, click <strong>"Activate over Internet"</strong></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 border-2 border-green-300 dark:border-green-700 rounded-2xl p-6 shadow-lg mb-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-green-800 dark:text-green-200">Project Activated!</h2>
                            <p className="text-green-700 dark:text-green-300">Your Microsoft Project Professional 2021 is now activated!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t-4 border-red-400 pt-8 mt-8">
                    <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/30 dark:to-orange-950/30 border border-red-200 dark:border-red-800 rounded-2xl p-6 mb-6">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-red-800 dark:text-red-200 mb-2">If Internet Activation Fails</h2>
                                <p className="text-red-700 dark:text-red-300">Use Telephone/Offline activation method</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <h3 className="text-lg font-bold mb-4">Telephone/Offline Activation:</h3>
                        <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                            <li>Choose <strong>Telephone / Offline activation</strong> to get the Installation ID</li>
                            <li>
                                Open: <a href="https://simplysolutions.co.in/getcid" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">simplysolutions.co.in/getcid</a>
                            </li>
                            <li>Enter your Installation ID to get the Confirmation ID</li>
                            <li>Wait 2-3 minutes for Confirmation ID</li>
                            <li>Enter the Confirmation ID in the activation window to finish activation</li>
                        </ol>
                        <div className="mt-4">
