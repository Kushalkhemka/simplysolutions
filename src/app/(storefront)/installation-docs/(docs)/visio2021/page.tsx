...
export const metadata = {
    title: 'Visio 2021 Professional Installation Guide | SimplySolutions',
    description: 'Complete step-by-step guide to install and activate Microsoft Visio 2021 Professional',
};

export default function Visio2021Page() {
    return (
            ...
            <div className="container max-w-5xl py-10 px-4 mx-auto">
                ...
                <div className="mb-10">
                    ...
                    <div className="text-center">
                        <div className="inline-block px-4 py-1.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white text-sm font-medium rounded-full mb-4">
                            Complete Guide
                        </div>
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Follow these instructions to install and activate Microsoft Visio Professional 2021.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-1 text-amber-700 dark:text-amber-300">
                                <li>If any old Microsoft Visio version is installed, <strong>uninstall it first</strong></li>
                ...
                <div className="space-y-8 mb-12">
                    <div className="bg-card border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4 mb-5">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">1</div>
                            <div>
                                <h3 className="text-2xl font-bold">Download Visio Professional 2021</h3>
                                <p className="text-muted-foreground">Download the official Retail image file (~4.7 GB)</p>
                            </div>
                        </div>
                        <div className="ml-14">
                            <a href="https://bit.ly/visio-pro-2021" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" className="gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white shadow-lg">
                                    <Download className="h-5 w-5" />
                                    Download Visio 2021 Professional
                                </Button>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">2</div>
                            <div>
                                <h3 className="text-2xl font-bold mb-3">Install Visio 2021</h3>
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold mb-3">Activate Visio 2021</h3>
                                <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                                    <li>Open Microsoft Visio 2021</li>
                                    <li>When prompted, enter your Visio 2021 license key</li>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 border-2 border-green-300 dark:border-green-700 rounded-2xl p-6 shadow-lg mb-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-green-800 dark:text-green-200">Visio Activated!</h2>
                            <p className="text-green-700 dark:text-green-300">Your Microsoft Visio Professional 2021 is now activated!</p>
                        </div>
                    </div>
                </div>
