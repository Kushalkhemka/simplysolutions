...
import { ArrowLeft, Download, AlertCircle, CheckCircle, Key, Phone, ExternalLink } from 'lucide-react';
import { Button } from '@/components/ui/button';

export const metadata = {
    title: 'Microsoft Office 2016 Installation Guide | SimplySolutions',
    description: 'Complete step-by-step guide to install and activate Microsoft Office Professional Plus 2016',
};

export default function Office2016GuidePage() {
    return (
            ...
            <div className="container max-w-5xl py-10 px-4 mx-auto">
                ...
                <div className="mb-10">
                    ...
                    <div className="text-center">
                        <div className="inline-block px-4 py-1.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-sm font-medium rounded-full mb-4">
                            Complete Guide
                        </div>
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Follow these simple instructions for a smooth installation and activation.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4 mb-5">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">1</div>
                            <div>
                                <h2 className="text-2xl font-bold">Get Your License Key (Mandatory)</h2>
                                <p className="text-muted-foreground">Generate your Office 2016 license key from the activation page</p>
                            </div>
                        </div>
                        <div className="ml-14">
                            <a href="https://simplysolutions.co.in/activate" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" className="gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-lg">
                    ...
                    {/* Step 2: Remove Old Office */}
                    <div className="bg-card border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4 mb-5">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">2</div>
                            <div>
                        ...
                        <div className="ml-14">
                            ...
                            <p className="mt-3 text-muted-foreground">If it doesn&apos;t download, try another browser. Run the tool, then restart your PC before continuing.</p>
                        </div>
                    </div>

                    {/* Step 3: Redeem & Install */}
                    <div className="bg-card border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4 mb-5">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-white flex items-center justify-center font-bold text-lg shadow-lg">3</div>
                            <div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-card border rounded-2xl p-6 shadow-sm">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <p className="text-lg">In the Activation Wizard, select: <strong>&quot;I want to activate the software by telephone&quot;</strong> (Select this Option Only), then click Next</p>
                                </div>
                            ...
                            <div className="bg-card border rounded-2xl p-6 shadow-sm">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <p className="text-lg">Enter the <strong>Confirmation ID</strong> in the Office app (column by column) to finish activation</p>
                                </div>
                                <div className="relative w-full max-w-2xl mx-auto rounded-xl overflow-hidden border shadow-lg mt-4">
                                    <Image
                            ...
                            <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 border-2 border-green-300 dark:border-green-700 rounded-2xl p-6 shadow-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-green-800 dark:text-green-200">Office 2016 Activated!</h3>
                                        <p className="text-green-700 dark:text-green-300">Your Office Professional Plus 2016 is now activated for lifetime!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-8 text-center bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-2xl p-8 border">
                    <p className="text-lg text-muted-foreground mb-4">If you get an error, send screenshot & order ID on WhatsApp!</p>
