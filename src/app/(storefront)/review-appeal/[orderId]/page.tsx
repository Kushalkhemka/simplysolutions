...
import { Star, Upload, CheckCircle, Loader2, X, Shield, XCircle, ArrowRight, Clock, IndianRupee } from 'lucide-react';
...
export default function ReviewAppealPage({ params }: PageProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!screenshot) {
            toast.error('Please upload a screenshot showing the review has been removed');
            return;
        }
        ...
        try {
            ...
            const response = await fetch('/api/review-appeal', {
                method: 'POST',
                body: formData,
            });
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center border border-gray-100">
                    ...
                    <p className="text-gray-600 mb-6">
                        ...
                        Our team will manually verify the review removal within 24-48 hours.
                    </p>
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-left mb-6">
                        ...
                        <ul className="text-sm text-green-700 space-y-1">
                            <li>• We will verify the product review has been removed</li>
            ...
            <div className="bg-purple-600 text-white py-4">
                <div className="container mx-auto px-4 text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                        ...
                        <h1 className="text-xl font-bold">PRODUCT REVIEW REMOVAL REQUEST</h1>
                    </div>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 md:p-8 mb-8">
                        <h2 className="text-xl font-bold text-gray-900 mb-4">
                            Why Remove Product Review?
                        </h2>
                        <p className="text-gray-600 mb-4">
                            Product reviews are crucial for our success as a small business. We strive to offer the best service,
                            but occasional issues may arise. Negative reviews severely impact our ability to serve customers.
                        </p>
                        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                            <p className="text-sm text-purple-800">
                                <span className="font-semibold">Note:</span> If you faced a genuine issue with the product,
                                please <a href="https://wa.me/918178848830" target="_blank" rel="noopener noreferrer" className="text-purple-700 underline font-medium">contact us on WhatsApp</a> first.
                                We will resolve your issue before asking for review removal.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-red-200 p-6 md:p-8 mb-8">
                        <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            ...
                            What You Lose with Negative Review
                        </h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="font-bold text-gray-900">WITH NEGATIVE REVIEW</h3>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-green-200 p-6">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="font-bold text-gray-900">AFTER REVIEW REMOVAL</h3>
                            </div>
                            <ul className="space-y-2 text-sm text-gray-600">
                                <li className="flex items-center gap-2">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
                        <h2 className="text-xl font-bold text-gray-900 mb-2">Submit Review Removal Proof</h2>
                        <p className="text-gray-600 mb-6">
                            Remove your product review on Amazon and upload a screenshot as proof.
                        </p>

                        {/* Steps */}
                        <div className="bg-gray-50 rounded-xl p-4 mb-6">
                            <p className="font-medium text-gray-900 mb-3">How to remove your product review:</p>
                            <ol className="space-y-2 text-sm text-gray-700">
                                <li className="flex gap-2">
                                    <span className="font-bold text-purple-600">1.</span>
                                    Go to <a href="https://www.amazon.in/your-account" target="_blank" rel="noopener noreferrer" className="text-purple-600 underline font-medium">amazon.in/your-account</a> → Ordering & shopping preferences → Your reviews
                                </li>
                                <li className="flex gap-2">
                                    <span className="font-bold text-purple-600">2.</span>
                                    Find the review for Order ID: {orderId}
                                </li>
                                <li className="flex gap-2">
                                    <span className="font-bold text-purple-600">3.</span>
                                    Click on the three dots (...) → &quot;Delete&quot; → Confirm
                                </li>
                                <li className="flex gap-2">
                                    <span className="font-bold text-purple-600">4.</span>
                                    Take a screenshot showing the review has been deleted
                                </li>
                            </ol>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative">
                                    {screenshotPreview ? (
                                        ...
                                        <label className="flex flex-col items-center justify-center h-48 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-purple-500 hover:bg-purple-50/50 transition-all group">
                                            <Upload className="w-10 h-10 text-gray-400 group-hover:text-purple-500 transition-colors" />
                                            <span className="text-sm text-gray-500 mt-2 group-hover:text-purple-600 font-medium">Click to Upload Screenshot</span>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {/* Partial Refund */}
                                    <label className={`flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${refundType === 'partial' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-gray-300'}`}>
                                        <input
                                            type="radio"
                                            name="refundType"
                                            value="partial"
                                            ...
                                            {refundType === 'partial' && (
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-32 px-3 py-2 border border-gray-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none bg-white text-gray-900"
                                                        min="1"
                                                    />
                                                </div>
                                            )}
                            ...
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white py-4 rounded-xl font-bold text-lg shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {isLoading ? (
                                    <>
