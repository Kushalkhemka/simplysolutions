                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-200 dark:border-white/10">
                        <h2 className="text-xl font-bold text-foreground mb-6 flex items-center gap-3">
                            <CheckCircle className="w-6 h-6 text-green-500" /> When Refunds Apply
                        </h2>
                        <ul className="space-y-3 text-muted-foreground">
                            <li className="flex gap-3"><CheckCircle className="w-4.5 h-4.5 text-green-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">Invalid License Key</strong> - Full refund or replacement if key doesn&apos;t work</span></li>
                            <li className="flex gap-3"><CheckCircle className="w-4.5 h-4.5 text-green-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">Duplicate Purchase</strong> - Refund for accidental double purchases (if unused)</span></li>
                            <li className="flex gap-3"><CheckCircle className="w-4.5 h-4.5 text-green-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">Wrong Product</strong> - Correct product provided or full refund</span></li>
                            <li className="flex gap-3"><CheckCircle className="w-4.5 h-4.5 text-green-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">Non-Delivery</strong> - Full refund if not delivered within 24 hours</span></li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-200 dark:border-white/10">
                        <h2 className="text-xl font-bold text-foreground mb-6 flex items-center gap-3">
                            <XCircle className="w-6 h-6 text-red-500" /> When Refunds Don&apos;t Apply
                        </h2>
                        <ul className="space-y-3 text-muted-foreground">
                            <li className="flex gap-3"><XCircle className="w-4.5 h-4.5 text-red-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">Change of Mind</strong> - After purchase completion</span></li>
                            <li className="flex gap-3"><XCircle className="w-4.5 h-4.5 text-red-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">Activated License</strong> - Once key is used on any device</span></li>
                            <li className="flex gap-3"><XCircle className="w-4.5 h-4.5 text-red-500 mt-1 flex-shrink-0" /><span><strong className="text-foreground">System Incompatibility</strong> - Check requirements before purchase</span></li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-200 dark:border-white/10">
                        <h2 className="text-xl font-bold text-foreground mb-6 flex items-center gap-3">
                            <Clock className="w-6 h-6 text-primary" /> Refund Process
                        </h2>
                    ...
                    <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-8 border border-primary/20">
                        <h2 className="text-xl font-bold text-foreground mb-4 flex items-center gap-3">
                            <ShieldCheck className="w-6 h-6 text-primary" /> Replacement Guarantee
                        </h2>
                        <p className="text-muted-foreground mb-4">We prefer to offer replacements to ensure you get working software:</p>
                        <ul className="space-y-2 text-muted-foreground">
                            <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" />Free replacement for non-working keys</li>
                            <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" />Priority activation support</li>
                            <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" />Lifetime key replacement guarantee (terms apply)</li>
                        </ul>
                    </div>

                    {/* Contact */}
                    <div className="text-center p-8 bg-white dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/10">
                        <Headset className="w-10 h-10 text-primary mx-auto mb-4" />
