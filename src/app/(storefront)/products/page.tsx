...
export const metadata: Metadata = {
    title: 'All Products - Buy Genuine Software Licenses',
    description: 'Browse our complete collection of genuine Microsoft software licenses. Windows, Office, Microsoft 365, and more with instant digital delivery at best prices in India.',
    keywords: [
        'software products',
        'Microsoft licenses',
        'Windows',
    ...
    openGraph: {
        ...
        description: 'Browse genuine Microsoft software licenses with instant digital delivery.',
        type: 'website',
