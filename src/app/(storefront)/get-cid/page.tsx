...
import { Key, Copy, CheckCircle, Loader2, AlertTriangle, RefreshCw, Phone, Package, HelpCircle } from 'lucide-react';
import { toast } from 'sonner';

export default function GetCIDByOrderPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!orderId.trim()) {
            toast.error('Please enter your Amazon Order ID');
            return;
        }
                ...
                <div className="container-dense">
                    <div className="flex items-center justify-center gap-3 mb-1">
                        ...
                        <h1 className="text-2xl md:text-3xl font-bold text-center text-white uppercase tracking-wider">
                            Phone Activation (FBA)
                        </h1>
                    </div>
                    <p className="text-center text-[#FF9900] text-sm font-medium">
                        Generate Confirmation ID using Order ID
                    </p>
                </div>
            </div>
                        ...
                        <div className="p-4">
                            <ol className="space-y-2 text-sm text-[#0F1111]">
                                ...
                                <li className="flex gap-2">
                                    ...
                                    <span>Enter your <strong>Amazon Order ID</strong> and Installation ID below</span>
                                </li>
                                <li className="flex gap-2">
                    ...
                    <div className="bg-white rounded-lg shadow-lg border border-[#DDD] overflow-hidden">
                        ...
                        <div className="bg-gradient-to-b from-[#F7F8FA] to-[#E7E9EC] px-6 py-4 border-b border-[#DDD]">
                            ...
                            <p className="text-sm text-[#565959] mt-1">
                                For Amazon FBA orders - use your Order ID instead of secret code
                            </p>
                        </div>
                        ...
                        <div className="p-6">
                            {confirmationId ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading || !orderId.trim() || digitCount !== 63}
