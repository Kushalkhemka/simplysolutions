                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg shadow-lg border border-[#DDD] overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            {/* Helper Note */}
                            <p className="text-xs text-[#565959] mb-4 flex items-start gap-1">
                                <span className="font-bold">*Note:</span>
                                <span>Find your Order ID in your Amazon order confirmation email or Amazon app order history.</span>
                            </p>

                            {/* Email Input for Updates */}
                            <div className="mb-4">
                                <label className="block text-sm font-bold text-[#0F1111] mb-2">
                                    YOUR EMAIL <span className="text-[#565959] font-normal">(for installation help)</span>
                                </label>
                                <input
                                    type="email"
                                    id="customer-email"
