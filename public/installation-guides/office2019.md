...
**NOTE - REDEEM THE LICENSE WITHIN 7 DAYS FROM DATE OF PURCHASE *Installation instruction:***
...
**NOTE - REDEEM THE LICENSE WITHIN 7 DAYS FROM DATE OF PURCHASE
 IMPORTANT NOTE - If you face the activation issues which is shown in below image then follow troubleshooting steps mentioned below :- ![](https://api.simplysolutions.co.in/storage/v1/object/public/product-assets/installation-guide-images/0.png) STEPS TO RESOLVE THE ISSUE -**
