// Script to add ASIN mapping and insert missing Acrobat item
...
const acrobatSKU = '1CCV-BL1Z-DF6N';
const acrobatFSN = 'ACROBAT2024';

async function fixOrder() {
    console.log('=== Step 1: Check/Add ASIN Mapping ===');
